...
class Currency extends React.Component {
    ...
    /* We use componentDidUpdate to handle a case where the user navigates through the list and click another currency. */
    ...
    /* In our componentDidMount()  lifecycle method we’re calling  getCurrency(url)  method to fetch a single currency with matching id.  */
    componentDidMount() {
        this.getCurrency(this.api_url + this.props.match.params.id + '/');
    }
